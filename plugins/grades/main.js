var templates = [
    ...
    "root/externallib/text!root/plugins/grades/lang/pt_br.json"
];
...
define(templates,function (activities, activityGrade, langStrings) {
    var plugin = {
        ...
        viewActivities: function(courseId) {
			...
			var pageTitle = MM.lang.s("notas","grades");
        ...
        viewActivityGrade: function(activityName, courseId, modName, cmId) {
            ...
            MM.moodleWSextCall('local_start_get_grades', data, function(contents) {
                var course = MM.db.get("courses", MM.config.current_site.id + "-" + courseId);
